...
import static com.coderminion.refreshlayout.Constants.REMOTE_URL;
...
public class Webservice {
    ...
    private static final String BASE_URL = REMOTE_URL;
    ...
    public static JSONObject getAndroidVersions()
    {
        HashMap<String,String> hashMap = new HashMap<>();

        JSONObject object = sendServer(hashMap, Constants.ANDROIDVERSIONS,GET_REQUEST);
